...
export default function SearchBar() {
    ...
    const { parse, errors, pending, results } = useContext(SearchContext)
        ...
        <>
            <form method="post" onSubmit={submitForm}>
                ...
                <button type="submit" disabled={pending} className="absolute top-1/2 -translate-y-1/2 right-1 clickable bg-blue-600 text-white rounded-full px-3 py-1">
                    {pending ? (
                    <svg aria-hidden="true" className="w-6 h-6 animate-spin text-white/20 fill-white" viewBox="0 0 100 101" xmlns="http://www.w3.org/2000/svg">
